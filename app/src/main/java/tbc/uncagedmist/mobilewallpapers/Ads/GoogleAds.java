package tbc.uncagedmist.mobilewallpapers.Ads;
...
public class GoogleAds {
    ...
    public static String PKG_APP = "tbc.uncagedmist.mobilewallpapers";

    public static InterstitialAd mInterstitialAd;

    public static void loadGoogleFullscreen(Context context)    {

        final String FULLSCREEN_ID = context.getString(R.string.FULL_SCREEN);
